...
<div align="center">
	<form action="select_passed_class_three" method="post">
		校区: <select id="select_district_one" name="district"
			onchange="district_change_one()">
			<option value="">全部</option>
			<option value="奉贤">奉贤</option>
			<option value="徐汇">徐汇</option>
		</select> 星期: <select id="select_theDay" name="theDay">
		...
		</select> 机房: <select id="select_classroom_one" name="classroomId">
...
<div align="center">
	...
	<table border="1" cellspacing="0">
		...
		<c:forEach items="${is}" var="ck" varStatus="st">
			<tr>
				...
				<td>${ck.software}</td>
				<td>${ck.applyTime}</td>
				<td><input type="radio" name="che"
					onclick=" checkId('${ck.classId} ','${ck.className }','${ck.teacherId}','${ck.teacherName}') " />选中
				</td>
			</tr>
		</c:forEach>
	</table>
	...
	<table border='1'>
		<tr>
			<td><br> 时间:<br>星期: <select id="selectTheDayTwo"
				name="select_theDay2">
					<option value="日">日</option>
					<option value="一">一</option>
					<option value="二">二</option>
					...
					<option value="五">五</option>
					<option value="六">六</option>
			</select> <br> 实验始末节:第 <select id="classStartPart"
				name="class_start_part">
			...
			</select> - <select id="classEndPart" name="class_end_part">
					<option value="1">1</option>
					<option value="2">2</option>
					<option value="3">3</option>
					<option value="4">4</option>
					...
					<option value="11">11</option>
					<option value="12">12</option>
			</select>节 <br> 实验单双周 <select id="weekType" name="weekType">
					<option value='0'>全周</option>
					<option value='1'>单周</option>
					<option value='2'>双周</option>
			</select> <br> 实验始末周:第 <select id="class_start_week"
				name="class_start_week">
			...
			</select> - <select id="class_end_week" name="class_end_week">
					<option value="01">1</option>
					<option value="02">2</option>
					<option value="03">3</option>
					<option value="04">4</option>
			...
			</select>周 <br> 地点:<br>校区: <select id="select_district_two"
				name="selectDistrict" onchange="district_change_two()">
					<option value="请选择">请选择</option>
					<option value="奉贤">奉贤</option>
					<option value="徐汇">徐汇</option>
			</select> 机房: <select id="select_classroom_two" name="choseClassroom">
			</select><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<button onclick='theTableSubmit()'>提交</button></td>
		</tr>
	</table>
</div>
