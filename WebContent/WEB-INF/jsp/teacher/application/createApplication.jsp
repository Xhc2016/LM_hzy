...
<form id="applicationForm">
	...
	<input class="required" type="text" id="teacherName" name="teacherName"
		value="${user.fullName}" title="require"> <br> <input
		type="text" id="teacherId" name="teacherId" value="${user.userId }">



	<br> <input class="required digits" type="text" id="phoneNumber"
		name="phoneNumber" value="${user.tellNumber }" title="请输入正确的联系方式">

	<br> <input class="required email" type="email" id="teacherEmail"
		name="teacherEmail" placeholder="${user.email}" title="请输入正确的电子邮箱">

	<br> <input class="required digits" type="text" id="classId"
		name="classId" placeholder="课程编号" title="请输入正确的课程编号"> <br>

	<input class="required" type="text" id="className" name="className"
		placeholder="课程名称" title="请输入正确的课程名称"> <br> 实验类别 <select
		id="classType" name="classType">
	...
	</select> <input type="text" id="studentNumber" name="studentNumber"
		placeholder="实验人数"> <br> 实验地点 <select id="classCampus"
		name="classCampus">

		<option>徐汇校区</option>
		<option>奉贤校区</option>

	</select> 学院 <select id="institute" name="institute">
	...
	</select> <br> <input type="text" class="required number"
		id="classTotalTime" name="classTotalTime" placeholder="实验总学时"
		title="请输入正确的学时数"> <br> 实验单双周 <select id="weekType"
		name="weekType">
		<option value="0">每周</option>
		<option value="1">单周</option>
		<option value="2">双周</option>
	</select> 实验起始周 <select id="classStartTime" name="classStartTime">
		<option>1</option>
		<option>2</option>
		<option>3</option>
		<option>4</option>
	...
	</select> - <select id="classEndTime" name="classEndTime">
		<option>1</option>
		<option>2</option>
		<option>3</option>
		<option>4</option>
	...
	</select> <br> 每周课时数 <select id="classWeekTime" name="classWeekTime">
		<option>未选择</option>
		<option>1</option>
		<option>2</option>
		<option>3</option>
	...
	<br> <input type="text" id="software" name="software"
		placeholder="软件要求"> <input type="text" id="remark"
		name="remark" placeholder="备注"> <br> <input type="submit"
		value="提交申请" id="submitApplication">
